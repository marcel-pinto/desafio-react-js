...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const unformatedTransactions = response.data.transactions;

      const formattedTransactions = unformatedTransactions.map(transaction => {
        const sign = {
          income: '',
          outcome: '- ',
        };
        const formattedValue =
          sign[transaction.type] + formatValue(transaction.value);
